...
class game : AppCompatActivity() {
    ...
    private lateinit var videoViewGame: VideoView
    private lateinit var mediaPlayerInPlane: MediaPlayer
    private lateinit var mediaPlayercatch: MediaPlayer
...
//                                lilu.visibility = View.INVISIBLE
    ...
    videoViewGame = findViewById(R.id.videoViewgame)

        val videoPath = "android.resource://" + packageName + "/" + R.raw.bakloopg
        videoViewGame.setVideoURI(Uri.parse(videoPath))

        videoViewGame.setOnPreparedListener { mp ->
            mp.isLooping = true
        }

        videoViewGame.start()

        mediaPlayerInPlane = MediaPlayer.create(this, R.raw.inplane)
